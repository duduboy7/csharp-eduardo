...
--
-- Host: 127.0.0.1
-- Tempo de geração: 15-Jun-2022 às 23:59
...
(2, 'Vicente', 777, 'Estudantes', '69729e049dae6ced1a17d9ded9e9185d.jpg', 1);
...
--
ALTER TABLE `tab_candidato`
  MODIFY `id_candidato` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
